    ...
    with open(input_file, mode='r', newline='', encoding='utf-8') as infile:
        ...
        with open(output_file, mode='w', encoding='utf-8') as sqlfile:
            ...
            for row in reader:
                ...
                sql_statement = (
                    "INSERT INTO Technical_Officials (Code, Disciplines, `Function`, Organisation_Country, Name, Gender) "
...
input_csv = 'technical_officials.csv'
output_sql = 'Insert_Technical_Officials.sql'
